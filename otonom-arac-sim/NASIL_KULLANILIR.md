...
### Alt Paneller
1. **Araç Durumları**: Her aracın ID, pozisyon, durum bilgileri
2. **Olaylar**: Simülasyonda olan önemli olaylar (çarpışma, bekleme, vb.)
3. **Sistem Bilgisi**: Yol uzunluğu, sensör sayısı gibi sabit bilgiler
